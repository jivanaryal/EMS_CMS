...
const InProgressTask = () => {
  ...
  const fileterEmployee = task.filter(
    (val) => val.status === "inprogress" || val.status === "pending"
  );
          ...
          {fileterEmployee.map((val, i) => {
            return (
              <tr className="border-b border-gray-400  hover:bg-gray-200 font-bold">
                ...
                <td className="py-3 px-4 border-l border-gray-400 text-center capitalize hidden sm:table-cell">
                  <img
